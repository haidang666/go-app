...
import (
	...
	auth2 "github.com/haidang666/go-app/internal/infrastructure/http/handlers/auth"
...
func ProvideSignUpUseCase(userRepo contract.UserRepository) *auth.SignUpUseCase {
